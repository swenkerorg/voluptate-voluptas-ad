# @swenkerorg/voluptate-voluptas-ad
...
__Motto of `@swenkerorg/voluptate-voluptas-ad` is simple__: *create the smallest possible CSS-in-JS library and provide all features of any other library through addons.*

- __Only [0.5 Kb](https://bundlephobia.com/result?p=@swenkerorg/voluptate-voluptas-ad@1.15.3)__ in base configuration, *e.g. [`styled-components`](https://github.com/styled-components/styled-components) is [15.1Kb](https://bundlephobia.com/result?p=styled-components@3.2.5)*
...
> For pre-configured simple-to-use package see [`nano-theme`](https://github.com/streamich/nano-theme), which builds on top of `@swenkerorg/voluptate-voluptas-ad`.
...
[npm-url]: https://www.npmjs.com/package/@swenkerorg/voluptate-voluptas-ad
[npm-badge]: https://img.shields.io/npm/v/@swenkerorg/voluptate-voluptas-ad.svg
[travis-url]: https://travis-ci.org/streamich/@swenkerorg/voluptate-voluptas-ad
[travis-badge]: https://travis-ci.org/streamich/@swenkerorg/voluptate-voluptas-ad.svg?branch=master
